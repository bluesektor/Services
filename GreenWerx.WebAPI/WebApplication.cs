...
namespace GreenWerx.Web
{
    public class WebApplication
    {
        ...
        //this was a pain in the ass to debug, re-implement later
        ...
        //
        public ServiceResult SaveConfigSetting(string key, string value)
        {
            if (string.IsNullOrWhiteSpace(key) || string.IsNullOrWhiteSpace(value))
                return ServiceResponse.Error("Key or value is missing data.");
            ...
            try
            {
                ...
                string binFile = AppDomain.CurrentDomain.BaseDirectory + "bin\\GreenWerx.WebAPI.dll.config";
